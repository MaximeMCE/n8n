    ...
    async serverStarted() {
        ...
        const info = {
            ...
            execution_variables: {
                ...
                executions_data_save_on_progress: config_2.default.getEnv('executions.saveExecutionProgress'),
                executions_data_save_manual_executions: config_2.default.getEnv('executions.saveDataManualExecutions'),
