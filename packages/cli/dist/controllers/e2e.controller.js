...
let E2EController = E2EController_1 = class E2EController {
    constructor(license, settingsRepo, workflowRunner, mfaService, cacheService, push, passwordUtility, eventBus, userRepository) {
    ...
    async truncateAll() {
        for (const table of tablesToTruncate) {
            try {
                ...
                di_1.Container.get(backend_common_1.Logger).warn('Dropping Table for E2E Reset error', {
                    error: error,
                });
            }
        }
