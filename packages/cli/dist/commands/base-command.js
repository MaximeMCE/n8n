...
const db_connection_1 = require("../databases/db-connection");
...
class BaseCommand extends core_1.Command {
    ...
    async init() {
        this.dbConnection = di_1.Container.get(db_connection_1.DbConnection);
    ...
    async finally(error) {
        ...
        if (backend_common_1.inTest || this.id === 'start')
            return;
