    ...
    deregisterRunner(runnerId, error) {
        ...
        for (const task of this.tasks.values()) {
            if (task.runnerId === runnerId) {
                ...
                this.handleRunnerReject(task.id, `The Task Runner (${runnerId}) has disconnected: ${error.message}`);
            }
        }
    }
